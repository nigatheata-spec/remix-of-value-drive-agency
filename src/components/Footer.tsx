...
const Footer = () => {
  ...
  const footerLinks = {
    services: [{
      label: t('services.brandIdentity.title'),
      href: "#"
    }, {
      label: t('services.socialMedia.title'),
      href: "#"
    }, {
      label: t('services.paidAds.title'),
      href: "#"
    }, {
    ...
    company: [{
      ...
      label: t('footer.ourProcess'),
      href: "#process"
    }, {
      label: t('portfolio.tag'),
      href: "/portfolio"
    }, {
  ...
  return <footer className="bg-secondary text-secondary-foreground pt-20 pb-8">
        ...
        <div className={`grid md:grid-cols-2 lg:grid-cols-4 gap-12 py-12 ${isRTL ? 'text-right' : ''}`}>
          <div className="lg:col-span-1">
            ...
            <div className={`flex items-center gap-4 mt-6 ${isRTL ? 'justify-end' : ''}`}>
              {socialLinks.map((social, index) => <a key={index} href={social.href} aria-label={social.label} className="w-10 h-10 rounded-full bg-white/5 hover:bg-primary flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <div className="mt-6">
              <p className="text-secondary-foreground/60">Email:
hello@valueplus.agency<strong className="text-secondary-foreground">{t('footer.email')}</strong><br />
                hello@valueplus.sa
              </p>
            </div>
          </div>
