...
import { ArrowRight, Rocket, Target, Zap, Globe, Heart } from "lucide-react";
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="w-px h-16 bg-gradient-to-b from-white/40 to-transparent mx-auto mt-4" />
            </motion.div>
          </motion.div>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <motion.div 
              ...
              className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent to-primary origin-top"
            ...
            {timeline.map((item, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ delay: 0.7 + index * 0.2, type: "spring", bounce: 0.5 }}
